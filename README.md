...
![NDCG@20](https://img.shields.io/badge/NDCG%4020-0.9562-brightgreen)
...
| Run | JD | NDCG@20 | CI |
|---|---|---|---|
| Default | Senior ML Engineer (HIGH) | 0.9562 | ±0.090 |
| Vague JD | MLOps vague (LOW) | 0.8438 | ±0.159 |
| No GitHub | Senior ML Engineer | 0.9423 | ±0.102 |
...
- NDCG = 0.9562 means our ranking very closely matches expert human judgment for this candidate pool
...
- **NDCG = 0.9562** means HireSynth's ranking closely matches expert human judgment, with a confidence interval of ±0.090
