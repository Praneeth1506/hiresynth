...
![NDCG@20](https://img.shields.io/badge/NDCG%4020-0.9293-brightgreen)
...
| Run | JD | NDCG@20 | CI |
|---|---|---|---|
| Default | Senior ML Engineer (HIGH quality) | 0.9293 | ±0.112 |
| Vague JD | MLOps vague (LOW quality) | 0.8438 | ±0.159 |
| No GitHub | Senior ML Engineer (no enrichment) | 0.9423 | ±0.102 |
...
- NDCG = 0.9293 means our ranking very closely matches human judgment for this candidate pool
...
- **NDCG = 0.9293** means HireSynth's ranking closely matches expert human judgment, with a confidence interval of ±0.112
